        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 relative h-[500px] md:h-[600px] w-full flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="absolute z-20 w-[65%] aspect-[3/4] rounded-t-full rounded-b-3xl bg-ghibli-paper shadow-2xl border-4 border-white overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-t from-ghibli-wood/40 to-transparent z-10"></div>
            ...
            <motion.div 
              ...
              className="absolute left-[5%] top-[25%] z-30 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-ghibli-wood/10"
            >
            ...
            <motion.div 
              ...
              className="absolute right-[5%] bottom-[15%] z-10 w-[45%] aspect-square rounded-[2rem] bg-[#E8B4B8]/20 shadow-lg border-2 border-white flex flex-col justify-center items-center p-4 text-center"
            >
            ...
            <motion.div 
              ...
              className="absolute right-[15%] top-[10%] z-30 bg-white p-3 rounded-full shadow-lg border border-ghibli-wood/10 flex items-center gap-2"
            >
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-px bg-ghibli-wood/40"></div>
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-ghibli-charcoal font-serif tracking-tight mb-8 leading-[1.1] relative">
              ...
              <div className="absolute bottom-2 left-0 w-full h-4 bg-ghibli-gold/20 -z-10 -rotate-2"></div>
            </h2>
            ...
            {/* Call to action (Only show if NOT on the About page) */}
            {!isAboutPage && (
              <Link 
                to="/about"
